...
export const signup = async (req, res) => {
	...
	try {
		...
		// If role is 'patient' or role is not provided, use Patient collection
		if (!role || role === 'patient') {
			...
			// Create patient in separate collection
...
export const login = async (req, res) => {
	...
	try {
		// If role is 'patient' or role is not provided, use Patient model
		if (!role || role === 'patient') {
