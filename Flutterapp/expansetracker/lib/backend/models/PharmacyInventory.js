...
pharmacyInventorySchema.methods.deductStock = async function(quantity, session = null) {
...
pharmacyInventorySchema.methods.addStock = async function(quantity, batchInfo, session = null) {
  this.stockQuantity += quantity;
