...
class ImagingCard extends StatelessWidget {
  ...
  final void Function(Map<String, dynamic> imaging)? onOpen;
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _info('Doctor', imaging['doctor']?.toString() ?? 'Not specified'),
              ),
              Expanded(
                child: _info('Facility', imaging['facility']?.toString() ?? 'Not specified'),
              ),
            ],
          ),
          if ((imaging['description']?.toString().isNotEmpty ?? false) ||
              (imaging['findings']?.toString().isNotEmpty ?? false)) ...[
          ...
          Align(
            ...
            child: ElevatedButton.icon(
              onPressed: onOpen == null ? null : () => onOpen!(imaging),
