...
class MedicationService {
  ...
  Future<List<Map<String, dynamic>>> fetchPatientMedications({
    ...
    final uri = Uri.parse('$_baseUrl/medications/patient/$patientId');
  ...
  Future<Map<String, dynamic>> createMedication({
    ...
    final res = await http
        .post(uri, headers: headers, body: json.encode(medication))
    ...
    throw Exception('Failed to create medication (${res.statusCode})');
  }
}
