...
import { Search, User, Calendar, Building, UserPlus } from 'lucide-react';
import { usePatient } from '../context/PatientContext';
import AddPatientModal from '../components/Modals/AddPatientModal';

const PatientHospitalizationsList = () => {
  ...
  const handlePatientClick = (patient) => {
    ...
    // Navigate to upload hospitalizations without patient ID in URL
    navigate('/upload-hospitalizations');
  };
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-indigo-600 to-indigo-800 text-white">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">Patient Hospitalizations Management</h1>
              <p className="mt-2 text-indigo-100">Select a patient to upload their hospitalization records</p>
            </div>
            <button 
              className="mt-4 md:mt-0 flex items-center justify-center bg-white text-indigo-700 py-2 px-4 rounded-md hover:bg-indigo-50 transition-colors font-medium"
...
export default PatientHospitalizationsList; 