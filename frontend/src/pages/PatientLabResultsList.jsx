...
import { Search, User, Calendar, TestTube, UserPlus } from 'lucide-react';
import { usePatient } from '../context/PatientContext';
import AddPatientModal from '../components/Modals/AddPatientModal';

const PatientLabResultsList = () => {
  ...
  const handlePatientClick = (patient) => {
    ...
    // Navigate to upload lab results without patient ID in URL
    navigate('/upload-lab-results');
  };
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-green-600 to-green-800 text-white">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">Patient Lab Results Management</h1>
              <p className="mt-2 text-green-100">Select a patient to upload their laboratory results</p>
            </div>
            <button 
              className="mt-4 md:mt-0 flex items-center justify-center bg-white text-green-700 py-2 px-4 rounded-md hover:bg-green-50 transition-colors font-medium"
