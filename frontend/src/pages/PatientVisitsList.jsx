...
import { Search, User, Calendar, FileText, UserPlus } from 'lucide-react';
...
const PatientVisitsList = () => {
  ...
  const handlePatientClick = (patient) => {
    ...
    // Navigate to upload visits without patient ID in URL
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-green-600 to-green-800 text-white">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">Patient Visits Management</h1>
              <p className="mt-2 text-green-100">Select a patient to upload their visit records</p>
            </div>
            <button 
