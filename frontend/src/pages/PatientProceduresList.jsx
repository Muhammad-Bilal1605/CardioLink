...
import { Search, User, Calendar, ClipboardList, UserPlus } from 'lucide-react';
import { usePatient } from '../context/PatientContext';
import AddPatientModal from '../components/Modals/AddPatientModal';

const PatientProceduresList = () => {
  ...
  const handlePatientClick = (patient) => {
    ...
    // Navigate to upload procedures without patient ID in URL
    navigate('/upload-procedures');
  };
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-purple-600 to-purple-800 text-white">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">Patient Procedures Management</h1>
              <p className="mt-2 text-purple-100">Select a patient to upload their medical procedures</p>
            </div>
            <button 
              className="mt-4 md:mt-0 flex items-center justify-center bg-white text-purple-700 py-2 px-4 rounded-md hover:bg-purple-50 transition-colors font-medium"
...
export default PatientProceduresList; 